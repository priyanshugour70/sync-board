...
<h3> Sync Board</h3>
  <p>
    <p style="font-size: 14px">
      sync-board is a modern admin dashboard template built with React 18, Vite, Ant Design, and TypeScript. It is designed to help developers quickly create powerful admin management systems.
    </p>
    <br />
...
```bash
git clone https://github.com/priyanshugour70/sync-board.git
```
